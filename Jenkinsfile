        ...
        stage('Upload to AWS'){
            steps {
                withAWS(region:'us-west-2',credentials:'aws-static') {
                    ...
                    def outputs = cfnUpdate(stack:'udacity-capstone-stack', file:'project.yaml', params:'project-parameters.json', keepParams:['Version'], timeoutInMinutes:10,onFailure:'ROLLBACK')
                }
            }
        }        
    }      
